...
function Dashboard() {
  return (
    ...
    <div className="floating-card" id="floatingCard" style={{TextAlign: "center"}}>
  ...
  <div style={{position: "relative"}}>
    ...
    <div style={{width:" 100%", height:" 100px", position: "absolute",bottom:" 0", BackgroundColor: "#ffffff", BorderTop:"1px solid #fafafa", BoxShadow: "0px -5px 15px 0px rgba(0, 0, 0, 0.1)"}}>
    ...
    <div style={{position: "absolute", top:" 50%", left: "50%", transform: "translate(-50%, -50%)"}}>
        <img src="do.jpeg" alt="Profile Photo" style={{width: "150px", height: "150px", BordeRadius: "50%"}}/>
    </div>
</div>
